...
password_label = Widget('CTkLabel', properties=Widget.parse(
...
confirm_label = Widget('CTkLabel', properties=Widget.parse(
...
login_label = Widget("CTkButton", properties=Widget.parse(
...
_frame.addChild([
    create_label, username_label, password_label, confirm_label,
    login_label, username_entry, password_entry, confirm_entry,
